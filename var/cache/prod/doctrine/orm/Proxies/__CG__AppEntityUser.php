...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'App\\Entity\\User' . "\0" . 'familyName', '' . "\0" . 'App\\Entity\\User' . "\0" . 'emailAddress', '' . "\0" . 'App\\Entity\\User' . "\0" . 'birthDate', '' . "\0" . 'App\\Entity\\User' . "\0" . 'sex', '' . "\0" . 'App\\Entity\\User' . "\0" . 'isMailAddressVerified'];
        }
     ...
     * {@inheritDoc}
     */
    public function setFamilyName(string $familyName): \App\Entity\User
    {
     ...
     * {@inheritDoc}
     */
    public function setEmailAddress(string $emailAddress): \App\Entity\User
    {
    ...
    public function getIsMailAddressVerified()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsMailAddressVerified', []);

        return parent::getIsMailAddressVerified();
    }
    ...
    public function setIsMailAddressVerified($isMailAddressVerified): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsMailAddressVerified', [$isMailAddressVerified]);

        parent::setIsMailAddressVerified($isMailAddressVerified);
    }
