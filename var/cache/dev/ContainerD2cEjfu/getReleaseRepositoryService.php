 ...
 */
class getReleaseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReleaseRepository' shared autowired service.
     *
     * @return \App\Repository\ReleaseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReleaseRepository.php';

        return $container->privates['App\\Repository\\ReleaseRepository'] = new \App\Repository\ReleaseRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
